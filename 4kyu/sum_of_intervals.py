...
# interval will always be less than the second value. Interval example: [1, 5] is an interval from
# 1 to 5. The length of this interval is 4.
#
...
# Fails due to poor time complexity
